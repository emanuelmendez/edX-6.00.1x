...
WORDLIST_FILENAME = "C:\py2\proyects\ProblemSet4\words.txt"
...
def updateHand(hand, word):
    ...
    for letter in hand:
        if letter in word:
            copyHand[letter] -= word.count(letter, 0, len(word))         
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score += points
                print "\"{0}\" earned {1} points. Total: {2} points".format(user_input, points, score)
                print ""
                # Update the hand 
