...
def compPlayHand(hand, wordList, n):
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a None):
            ...
            score += points
            print "\"{0}\" earned {1} points. Total: {2} points".format(compWord, points, score)
            print ""
            # Update the hand 
...
def playGame(wordList):
    ...
    while (True):
        ...
        choose = raw_input("Enter u to have yourself play, c to have the computer play: ")
        if choose == "u":
